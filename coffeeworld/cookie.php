...
if(isset($_COOKIE[$_GET['id']])) {
        $val = $_COOKIE[$_GET['id']];
        $val = $val+1;
        setcookie($_GET['id'], $val , time()+ 60 * 60 * 24 *5);
    } else {
        setcookie($_GET['id'], '1' , time()+ 60 * 60 * 24 *5);
    }
...
if(isset($_COOKIE['eigthprod']))
{
   
    setcookie("ninthprod",$_COOKIE["eigthprod"],time() + (86400*50));
}
...
if(isset($_COOKIE['fourthprod']))
{
    ...
    setcookie("fifthprod",$_COOKIE["fourthprod"],time() + (86400*50));
     $var[] = $_COOKIE["fourthprod"];
        $ar2 = array_count_values($var);
   print_r($ar2);
